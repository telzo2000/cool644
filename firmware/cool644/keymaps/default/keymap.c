...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT, KC_LCTL, KC_LGUI, KC_LALT, LT(_LOWER,KC_SPACE),LT(_RAISE,KC_SPACE),KC_BSPC,  KC_LEFT,  KC_DOWN, KC_RIGHT,
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,   KC_INSERT, KC_SPACE,  KC_SPACE,  LT(_LOWER,KC_SPACE), KC_MINS, KC_BSPC,  KC_LEFT,  KC_DOWN, KC_RIGHT,
    KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO
  ) ,
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TAB,   KC_INSERT,  KC_SPACE,   KC_SPACE,       LSFT(KC_MINS), LT(_RAISE,KC_SPACE), KC_LCTL,  KC_LGUI,   KC_LALT,   KC_BSPC,
    KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO
  ) 
};
